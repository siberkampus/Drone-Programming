...
#Goto_position_target_local_ned fonksiyonu Drona yön vermek için kullanılır. İlk parametre KUZEY,ikinci parametre BATI,
#Üçüncü parametre yerden yüksekliği belirtir. Önüne "-"(Eksi) işareti konulunca ters yönü ifade eder
...
while(True): 
    ...
    #Görüntümüz 640-480 pixel olduğu için merkezi 320-240'tır
    #Merkeze küçük bir daire çizdirilir
    ...
    if circles is not None: 
        ...
        #İlk algılanan daire en büyük kabul edilir
        
        for i in circles[0,:]:
            if(i[2]>biggest_circle[2]):
                biggest_circle=i
                #Eğer ilk daireden daha büyük daire varsa,en büyük daire yeni daire kabul edilir

        
            
        center = (biggest_circle[0], biggest_circle[1])
        # En büyük dairenin merkez koordinatları
        ...
        if (center[0]<290):{
            ...
            #Doğuya 1 metre gider
           
        }
        elif(center[0]>350):{
            goto_position_target_local_ned(0,1,0),
            #Batıya 1 Metre gider
        }
        else:{
            print("Dur")
        }
        if(center[1]<210):{
            ...
            #Kuzeye 1 Metre gider
           
        }
        elif(center[1]>260):{
            goto_position_target_local_ned(-1,0,0),
            #Güneye 1 Metre gider
        }
        else:{
            print("Dur")
        }
